...
export default async function BookingConfirm({
	...
	console.log(dayjs.tz(booking?.appointmentTime).format('HH:mm'));
			...
			booking?.paymentStatus === 'FUEL_CARD' ? (
				<div className="flex flex-col">
					...
					<div
						...
						role="alert"
					>
						<span className="font-medium mr-2">Status</span> Sie
						können den Status dieser Buchung über ihr{' '}
					...
					{/* <hr className="h-px my-8 bg-sky-700 border-0" /> */}
				</div>
			) : (
